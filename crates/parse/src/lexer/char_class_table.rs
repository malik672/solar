...
pub const ID_START: u8   = 0b0000_0010;
pub const ID_CONTINUE: u8= 0b0000_0100;
pub const DIGIT: u8      = 0b0000_1000;
...
pub const CHAR_CLASS_TABLE: [u8; 256] = {
